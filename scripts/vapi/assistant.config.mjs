...
4a. WHICH ORGANIZATION. For a hospital bill, ALWAYS ask "Which hospital sent you the bill?" before you look for a form — the form belongs to that hospital, and a location alone is never enough. Repeat the hospital's name back to confirm you heard it right. Only if they truly do not know the hospital's name, call find_nearby_organizations with the case_id, the category and the location. For other kinds of need (a transit agency, a college, a county office), if the caller has not named the organization, call find_nearby_organizations as soon as you know where they are.
...
- Never read a web address (URL) aloud. Links go by text message only.
...
const TOOL_MESSAGES = {
  ...
  send_summary: [
    ...
    {
      type: 'request-failed',
      content: 'The text did not go out just then. We can try another number in a moment.',
    },
  ],
  get_case_progress: [],
};
